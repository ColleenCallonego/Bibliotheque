    ...
    <b-card title="Emprunts" style="max-width: 50rem; box-shadow: 0px 5px 10px darkgray">
      <div>
        ...
        <div class="input-class">
          ...
          <b-button style="background-color: #e5dcd1;color: black; margin-left: 10px" v-bind:disabled="changeClicDispo" v-on:click="postFormDisponibilite()">DISPONIBILITE</b-button><br>
        </div>
        ...
        <div class="input-class">
          ...
          <b-button style="background-color: #e5dcd1;color: black" v-bind:disabled="changeClicEmprunt" v-on:click="postFormEmprunt()">EMPRUNTER</b-button><span>{{reponseAPI}}</span>
        </div>
